...
- Governments are moving toward scanning private messages by default, not by warrant
- Sending normal encrypted messages is risky because it might flag you on basis of suspicioun 
- Today it's "just CSAM." Scope creep is the pattern, not the exception
- Once the infrastructure exists, it doesn't get removed — it gets expanded
...
- ✅ Creates an isolated `.conversation-stenography-venv` when dependencies are needed
